...
FILES_TO_TRANSFER = [
    ...
    # r"D:\zzr\server_fedavg\train_runner.py",
    # r"D:\zzr\server_fedavg\scripts\comm_sender_simple.py",
    r"D:\zzr\server_fedavg\scripts\idle_power_runner.py",
]

# 2. 远程目标路径 (所有设备统一放这里)
REMOTE_PATH = "~/server_fedavg/scripts/"  # 建议指定到具体项目文件夹，例如 ~/FedProject/
